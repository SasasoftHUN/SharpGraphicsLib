...
{
    internal class WGLES30Context : WGLContext
#if OPENTK4
        , IBindingsContext
#endif
    {
        ...
        internal WGLES30Context() { }
        internal WGLES30Context(IGraphicsView graphicsView, in ReadOnlySpan<GLContextVersion> contextVersionRequests, bool debugContext, WGLContextCreationRequest? contextCreationRequest) : base(graphicsView, contextVersionRequests, debugContext, contextCreationRequest)
        {
