...
{
    internal sealed class GLES30ClearCommand : IGLCommand
    {
        ...
        internal GLES30ClearCommand(in Vector2UInt size, in ReadOnlySpan<GLClearColor> clearColors, float? clearDepth, int? clearStencil, IMemoryAllocator allocator)
        {
            _size = size;
