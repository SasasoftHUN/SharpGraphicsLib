...
{
    internal sealed class GLES30ViewportScissorCommand : IGLCommand
    {

        private readonly RectInt _rect;
        private readonly bool _enableScissor;

        internal GLES30ViewportScissorCommand(in RectInt rect, bool enableScissor)
        {
            _rect = rect;
    ...
    internal sealed class GLES30ViewportCommand : IGLCommand
    {

        private readonly RectInt _rect;

        internal GLES30ViewportCommand(in RectInt rect) => _rect = rect;
    ...
    internal sealed class GLES30ScissorCommand : IGLCommand
    {

        private readonly RectInt _rect;
        private readonly bool _enableScissor;

        internal GLES30ScissorCommand(in RectInt rect, bool enableScissor)
        {
            _rect = rect;
            _enableScissor = enableScissor;
        }
