...
namespace SharpGraphics.GraphicsViews.NETAvalonia
{
    public static class AvaloniaUtils
    {
        ...
        public static OperatingSystem ToOperatingSystem(this OperatingSystemType os)
            => os switch
            {
                OperatingSystemType.WinNT => OperatingSystem.Windows,
                OperatingSystemType.Linux => OperatingSystem.Linux,
                OperatingSystemType.OSX => OperatingSystem.MacOS,

                OperatingSystemType.Android => OperatingSystem.Android,
                //TODO: OperatingSystemType.iOS => OperatingSystem.iOS,
        ...
        public static SharpGraphics.GraphicsViews.KeyboardEventArgs ToUserInterfaceEvent(this Avalonia.Input.KeyEventArgs keyEvent, bool isPressed) =>
            new SharpGraphics.GraphicsViews.KeyboardEventArgs(keyEvent.Key.ToKeyboardKey(), isPressed);
